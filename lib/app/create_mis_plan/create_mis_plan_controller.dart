...
class CreateMisPlanController extends GetxController {
  ///
  CreateMisPlanController(
    this.createMisPlanPresenter,
  );
  CreateMisPlanPresenter createMisPlanPresenter;
  ...
  Future<void> setType() async {
    try {
      // Read jobId
      String? _type = await createMisPlanPresenter.getValue();
      if (_type == null || _type == '' || _type == "null") {
        var dataFromPreviousScreen = Get.arguments;

        type.value = dataFromPreviousScreen['type'];
        print({"typeeee", type.value});
        createMisPlanPresenter.saveValue(type: type.value.toString());
      } else {
  ...
  Future<void> getFrequencyList() async {
    final list = await createMisPlanPresenter.getFrequencyList(isLoading: true);
  ...
  Future<void> getPreventiveCheckList(
    ...
    final list = await createMisPlanPresenter.getPreventiveCheckList(
  ...
  Future<bool> createAuditNumber() async {
    ...
    await createMisPlanPresenter.createAuditNumber(
