                                                ...
                                                Text(
                                                  controller.isFormInvalid ==
                                                      ...
                                                      ? controller.selectedItem ==
                                                              null
                                                          ? "Course Category Create Successfully in the List."
                                                          : "Course Category updated Successfully in the List."
                                    ...
                                    child: controller.selectedItem == null
                                        ? Container(
                                            ...
                                            child: CustomElevatedButton(
                                              ...
                                              onPressed: () {
                                                controller.createCourseCategory().then(
                                                  (value) {
                                                    print("CREATE");
                                                    print("value,$value");
                                                    if (value == true) {
                        ...
                        child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              controller.CourseCategory.isEmpty == true &&
                                          ...
                                          child: Obx(
                                            () => DataTable2(
                                              ...
                                              rows: List<DataRow>.generate(
                                                controller.CourseCategory.length ?? 0,
                                                (index) => DataRow(cells: [
                                                  DataCell(Text(
                                                      (index + 1).toString())),
                                                  DataCell(Text(controller
                                                          .CourseCategory[index].name
                                                          .toString() ??
                                                      '')),
                                                  DataCell(Text(controller
