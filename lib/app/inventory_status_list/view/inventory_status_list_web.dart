              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    constraints: BoxConstraints(maxHeight: 240, minHeight: 220),
                    decoration: BoxDecoration(
                                            ...
                                            Text(
                                              controller.isFormInvalid == false
                                                  ? controller.selectedItem ==
                                                          null
                                                      ? "Create Assets Status Successfully in the List."
                                                      : "Create Assets Status updated Successfully in the List."
                                                  : "Create Assets Status is not added.",
                                              style: TextStyle(
                                                  fontSize: 16,
                              ...
                              child: Obx(
                                () => DataTable2(
                                  ...
                                  rows: List<DataRow>.generate(
                                    controller.inventoryStatusList?.length ?? 0,
                                    (index) => DataRow(cells: [
                                      DataCell(Text((index + 1).toString())),
                                      DataCell(Text(controller
                                              .inventoryStatusList?[index]?.name
                                              .toString() ??
                                          '')),
                                      DataCell(Text(controller
                                              .inventoryStatusList?[index]
                                              ?.description ??
                                          '')),
                                      DataCell(Row(
                                        children: [
