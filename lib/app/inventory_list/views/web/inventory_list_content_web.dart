                ...
                children: [
                  Padding(
                    ...
                    child: PopupMenuButton<String>(
                      ...
                      itemBuilder: (c) => controller.inventoryColumnVisibility
                          .map(
                            (e) => PopupMenuItem<String>(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    controller.checkSelectedColumnVisibility(
                                            columnName: e.text)
                                        ? Icon(
                                            Icons.check,
                                            color: Colors.red,
                                  ...
                                  : Expanded(
                                      child: ScrollableTableView(
                                        paginationController:
                                            controller.paginationController,
                                        columns: controller
                                            .selectedInventoryColumnVisibility
                                            .map((column) {
                                          return TableViewColumn(
                                            minWidth: Get.width /
                                                _controller
