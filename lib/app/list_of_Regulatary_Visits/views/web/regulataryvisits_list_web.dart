...
class VisitandNoticeListWeb extends StatefulWidget {
  VisitandNoticeListWeb({
    Key? key,
  }) : super(key: key);

  @override
  State<VisitandNoticeListWeb> createState() => _VisitandNoticeListWebState();
}

class _VisitandNoticeListWebState extends State<VisitandNoticeListWeb> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<RegulataryDataListController>(
        ...
        builder: (controller) {
          return Obx(
            () {
              final dataSource = VisitandNoticeDataListSource(controller);
                            ...
                            child: Card(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  controller.visitandnoticeList.isEmpty ==
                                              true &&
...
class VisitandNoticeDataListSource extends DataTableSource {
  final RegulataryDataListController controller;

  late List<GetVisitAndNoticeList?> filteredGetVisitAndNoticeList;

  VisitandNoticeDataListSource(this.controller) {
    filtersOccupationalhealth();
  }

  ///
  void filtersOccupationalhealth() {
    filteredGetVisitAndNoticeList = <GetVisitAndNoticeList?>[];
    filteredGetVisitAndNoticeList =
        controller.visitandnoticeList.where((VisitandnoticeList) {
      return (VisitandnoticeList.id ?? '')
          .toString()
          .contains(controller.monthnameFilterText.value.toLowerCase());

      // Add other filter conditions as needed
    }).toList();
    // print({"filteredGetVisitAndNoticeList": filteredGetVisitAndNoticeList});
  }

  @override
  DataRow? getRow(int index) {
    // print({"getRow call"});
    final VisitAndNoticeDetails = filteredGetVisitAndNoticeList[index];
    ...
    var cellsBuffer = [
      ...
      '${VisitAndNoticeDetails?.noticesToContractor?? ''}',
  ...
  @override
  int get rowCount => filteredGetVisitAndNoticeList.length;
