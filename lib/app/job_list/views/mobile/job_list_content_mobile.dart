                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                          shrinkWrap: true,
                          itemCount: controller.jobList != null ? controller.jobList.length : 0,
                          itemBuilder: (context, index) {
                            final jobModel = controller.jobList != null ? controller.jobList[index] : JobModel();
                                            ...
                                            Flexible(
                                              child: Text(
                                                (jobModel?.breakdownTime!= null)
                                                   ? DateFormat('dd-MMM-yyyy hh:mm').format(jobModel!.breakdownTime!)
                                                    : '',
                                                style: const TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  color: ColorValues.navyBlueColor,
