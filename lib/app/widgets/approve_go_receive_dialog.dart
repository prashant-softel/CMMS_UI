...
class ApproveGOReceiveDialog extends GetView {
  int? id;

  ApproveGOReceiveDialog({super.key, this.id});
        ...
        actions: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                _controller.approveGOReceiveButton(id: id);
                print('Goods order id:$id');
                Get.back();
              },
              child: Text('Approve GO Receive'),
            ),
          ]),
        ],
      );
