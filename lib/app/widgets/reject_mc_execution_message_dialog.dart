...
class RejectMcExecutionMessageApproveDialog extends GetView {
  String? data;
  List<dynamic>? id;

  RejectMcExecutionMessageApproveDialog({super.key, this.data, this.id});
        ...
        actions: [
          ...
          Center(
            child: ElevatedButton(
              ...
              child: const Text('MC Execution List'),
            ),
          ),
          Dimens.boxWidth10
        ],
