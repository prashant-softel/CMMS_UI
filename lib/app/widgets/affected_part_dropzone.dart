...
class AffectedPartDropzone extends StatefulWidget {
  const AffectedPartDropzone({Key? key}) : super(key: key);

  @override
  _AffectedPartDropzoneState createState() => _AffectedPartDropzoneState();
}

class _AffectedPartDropzoneState extends State<AffectedPartDropzone> {
  final AffectedPartUploadController controller =
