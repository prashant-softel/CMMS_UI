...
class GoodsOrderApprovedDialog extends GetView {
  int? id;

  GoodsOrderApprovedDialog({super.key, this.id});
        ...
        actions: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                _controller.goodsOrderApprovedButton(id: id);
                print('Goods order id:$id');
                Get.back();
              },
              child: Text('Approve GoodsOrder'),
            ),
          ]),
        ],
      );
