...
class FileUpload3DetailsWidgetWeb extends StatelessWidget {
  FileUpload3DetailsWidgetWeb({super.key});

  final FileUploadController3 _fileUploadController =
      Get.find<FileUploadController3>();
