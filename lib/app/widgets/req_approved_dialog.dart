...
class ReqOrderApprovedDialog extends GetView {
  int? id;

  ReqOrderApprovedDialog({super.key, this.id});
        ...
        actions: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                _controller.approveGoodsOrder(id: id);
                print('req order id:$id');
                Get.back();
              },
              child: Text('Approve GR'),
            ),
          ]),
        ],
      );
