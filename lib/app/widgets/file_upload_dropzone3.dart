...
class FileUploadWidgetWithDropzone3 extends StatefulWidget {
  FileUploadWidgetWithDropzone3({
    Key? key,
  }) : super(key: key);

  @override
  State<FileUploadWidgetWithDropzone3> createState() =>
      _FileUploadWidgetWithDropzoneState();
}

class _FileUploadWidgetWithDropzoneState
    extends State<FileUploadWidgetWithDropzone3> {
  ///
  final FileUploadController3 controller = Get.find<FileUploadController3>();
