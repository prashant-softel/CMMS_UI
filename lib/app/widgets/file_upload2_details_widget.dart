...
class FileUpload2DetailsWidgetWeb extends StatelessWidget {
  FileUpload2DetailsWidgetWeb({super.key});

  final FileUploadController2 _fileUploadController =
      Get.find<FileUploadController2>();
