...
class CalibrationCertificateController extends GetxController {
  CalibrationCertificateController(
    this.calibrationCertificatePresenter,
  );
  CalibrationCertificatePresenter calibrationCertificatePresenter;
  ...
  RxList<CalibrationCertificateModel?>?
  moduleList =
      <CalibrationCertificateModel?>[].obs;
  int facilityId = 0;
  int type = 1;
  ...
  CalibrationCertificateModel? moduleListModel;
  ...
  CalibrationCertificateModel? selectedItem;
  ...
  async {
    moduleList?.value = <CalibrationCertificateModel>[];
    final _moduleList =
        await calibrationCertificatePresenter.getCalibrationList(
            facilityId: facilityId, type: type, isLoading: isLoading);

    if (_moduleList != null) {
      moduleList!.value = _moduleList.cast<CalibrationCertificateModel?>();
  ...
  //     await calibrationCertificatePresenter.createModulelistNumber(
  ...
  //   {
  //     await calibrationCertificatePresenter.deleteModulelist(
  //       module_id,
  //       isLoading: true,
  //     );
  //   }
  ...
  //
  //   CalibrationCertificateModel createModulelist = CalibrationCertificateModel(
  //       id:moduleId,
  //       moduleName: _modulelistNumber,
  ...
  //   await calibrationCertificatePresenter.updateModulelistNumber(
  //     modulelistJsonString: modulelistJsonString,
  //     isLoading: true,
  //   );
  //   return true;
