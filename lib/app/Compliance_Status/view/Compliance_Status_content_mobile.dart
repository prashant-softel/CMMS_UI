...
import '../Compliance_Status_controller.dart';

class ComplianceStatusContentMobile
    extends GetView<ComplianceStatusController> {
  ComplianceStatusContentMobile({Key? key}) : super(key: key);
            ...
            children: [
              Expanded(
                child: ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: controller.ComplianceStatus != null
                        ? controller.ComplianceStatus.length
                        : 0,
                    itemBuilder: (context, index) {
                      final preventiveCheckListModel =
                          (controller.ComplianceStatus != null)
                              ? controller.ComplianceStatus[index]
