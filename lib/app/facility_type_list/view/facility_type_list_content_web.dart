                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(child: CustomRichText(title: 'Plant Name ')),
                                        Expanded(
                                            child: Container(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Expanded(child: RichText(
                                          text: TextSpan(text: "Pin", style: Styles.blackBold16, children: [
                                            TextSpan(
                                              style: TextStyle(
                                                color: ColorValues.orangeColor,
                                                fontWeight: FontWeight.bold,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(child: RichText(
                                          text: TextSpan(text: "Description", style: Styles.blackBold16, children: [
                                            TextSpan(
                                              style: TextStyle(
                                                color: ColorValues.orangeColor,
                                                fontWeight: FontWeight.bold,
