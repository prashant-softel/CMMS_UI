          ...
          child: Row(
            children: [
              ...
              InkWell(
                ...
                child: Text(" / NEW PERMIT LIST", style: Styles.greyLight14),
              ),
              Text(" / VIEW PERMIT", style: Styles.greyLight14)
            ],
          ),
        ),
        SizedBox(
                                    ...
                                    ScrollableTableView(
                                      ...
                                      rows: //
                                        ...
                                        return TableViewRow(
                                            onTap: () => {
                                                  print(
                                                      'ZERO = ${_inventoryDetailList[0]}')
                                                },
                                            height: 45,
                                            cells: _inventoryDetailList
                                                .map((value) {
                                ...
                                child: Column(
                                    ...
                                    children: [
                                        ...
                                        rows: //
                                          ...
                                          ...List.generate(
                                            ...
                                            (index) {
                                              ...
                                              print(
                                                  'Employee Idss5:${controller.id.value}');
                                              return [
                                      ...
                                      Padding(
                                        ...
                                        child: ValueListenableBuilder(
                                            valueListenable: controller
                                                .employeeNamepaginationController,
                                            builder: (context, value, child) {
                                              return Row(children: [
                                                Text(
                        ...
                        Column(
                          children: [
                            ...
                            Wrap(
                              alignment: WrapAlignment.start,
                              spacing: 100,
                              children: []..addAll(controller.safetyMeasureList
                                  .map((element) => Column(
                                        mainAxisSize: MainAxisSize.min,
                                        mainAxisAlignment:
