    ...
    return Scaffold(
        ...
        body: RepaintBoundary(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                (Responsive.isMobile(context) || Responsive.isTablet(context)) ? Dimens.box0 : HomeDrawer(),
                Obx(
                  () => Expanded(
                    child: Container(
                      width: MediaQuery.of(context).size.width,
                          ...
                          if (Responsive.isMobile(context)) {
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Text(" / NEW PERMIT LIST", style: Styles.greyMediumLight12),
                                      ),
                                      Text(" / VIEW PERMIT", style: Styles.greyMediumLight12)
                                    ],
                                  ),
                                ),
                                SizedBox(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(color: Color.fromARGB(255, 6, 83, 146), fontWeight: FontWeight.bold),
                                      ),
                                    ),
                                    // SizedBox(
                                    //   width: 350,
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        CustomRichText(title: 'Permit No: '),
                                        SizedBox(
                                          height: 1,
                                        ),
                                        CustomRichText(title: 'Permit Type: '),
                                        SizedBox(
                                          height: 1,
                                        ),
                                        CustomRichText(title: 'Site Permit No: '),
                                        SizedBox(
                                          height: 2,
                                        ),
                                        CustomRichText(
                                        ...
                                        controller.permitId != null
                                            ? SizedBox(
                                                ...
                                                child: Wrap(
                                                  ...
                                                  spacing: 100,
                                                  children: []..addAll(controller.listCategory!.map((element) => Row(
                                                            ...
                                                            Expanded(
                                                              child: //
                                                                ...
                                                                rows: //
                                                                  ...
                                                                  return TableViewRow(
                                                                      onTap: () => {print('ZERO = ${_inventoryDetailList[0]}')},
                                                                      height: 45,
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: ValueListenableBuilder(
                                                                  ...
                                                                  builder: (context, value, child) {
                                                                    return Row(children: [
                                                                      Text(
                                                                          "${controller.inventoryDetailPaginationController.currentPage}  of ${controller.inventoryDetailPaginationController.pageCount}"),
                                                                      Row(children: [
                                                                        IconButton(
                                                                          ...
                                                                          icon: Icon(
                                                                            ...
                                                                            color: controller.inventoryDetailPaginationController.currentPage <= 1
                                                                                ? Colors.black26
                                                                                : Theme.of(context).primaryColor,
                                                                          ),
                                                                        ),
                                                                        IconButton(
                                                                          onPressed: controller.inventoryDetailPaginationController.currentPage >=
                                                                                  controller.inventoryDetailPaginationController.pageCount
                                                                              ? null
                                                                              : () {
                                                                          ...
                                                                          icon: Icon(
                                                                            ...
                                                                            color: controller.inventoryDetailPaginationController.currentPage >=
                                                                                    controller.inventoryDetailPaginationController.pageCount
                                                                                ? Colors.black26
                                                                                : Theme.of(context).primaryColor,
                                                                          ),
                                    ...
                                    child: Container(
                                      ...
                                      child: SingleChildScrollView(
                                        child: Column(
                                          children: [
                                            CustomAppBar(
                                              title: 'Team Deployed to carry out the job'.tr,
                                            ),
                                            Dimens.boxHeight10,
                                            Wrap(
                                              children: [
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: ValueListenableBuilder(
                                                                    ...
                                                                    builder: (context, value, child) {
                                                                      return Row(children: [
                                                                        Text(
                                                                            "${controller.employeeNamepaginationController.currentPage}  of ${controller.employeeNamepaginationController.pageCount}"),
                                                                        Row(children: [
                                                                          IconButton(
                                                                            ...
                                                                            icon: Icon(
                                                                              Icons.arrow_back_ios_new_rounded,
                                                                              color: controller.employeeNamepaginationController.currentPage <= 1
                                                                                  ? Colors.black26
                                                                                  : Theme.of(context).primaryColor,
                                                                            ),
                                                                          ),
                                                                          IconButton(
                                                                            onPressed: controller.employeeNamepaginationController.currentPage >=
                                                                                    controller.employeeNamepaginationController.pageCount
                                                                                ? null
                                                                                : () {
                                                                            ...
                                                                            icon: Icon(
                                                                              Icons.arrow_forward_ios_rounded,
                                                                              color: controller.employeeNamepaginationController.currentPage >=
                                                                                      controller.employeeNamepaginationController.pageCount
                                                                                  ? Colors.black26
                                                                                  : Theme.of(context).primaryColor,
                                                                            ),
                                    ...
                                    child: Container(
                                      ...
                                      child: SingleChildScrollView(
                                        child: Column(
                                          children: [
                                            CustomAppBar(
                                              title: 'Following safety Measures taken to\ncarry out the work'.tr,
                                            ),
                                            Dimens.boxHeight10,
                                            Wrap(
                                              children: [
                                                ...
                                                Column(
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: CustomRichText(title: 'JSA: '),
                                                    ),
                                                    SizedBox(
                                                      height: 30,
                                                    ),
                                        ...
                                        children: [
                                          ...
                                          Wrap(
                                            children: [
                                              ...
                                              Text('File List will Appear Here')
                                            ],
                                          ),
                                        ],
                                      ),
                            ...
                            return SingleChildScrollView(
                              child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          ...
                                          _flutterSecureStorage.delete(key: "permitId");
                                          Get.back();
                                        },
                                        child: Text(" / NEW PERMIT LIST", style: Styles.greyMediumLight12),
                                      ),
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          Text('${controller.viewPermitDetailsModel.value?.sitePermitNo}', style: Styles.blue17),
                                        ],
                                      ),
                                      // Text(
                                      //   '${controller.viewPermitDetailsModel.value?.title}',
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(10),
                                          border: Border.all(
                                            color: controller.viewPermitDetailsModel.value?.ptwStatus == PermitStatusConstants.PTW_APPROVE //125
                                                    ||
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text('${controller.viewPermitDetailsModel.value?.siteName}',
                                              overflow: TextOverflow.clip, style: Styles.blue17),
                                          SizedBox(
                                            child: Text('${controller.startDateTimeCtrlr.text}', style: Styles.blue17),
                                          ),
                                          Dimens.boxHeight5,
                                      ...
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text('${controller.viewPermitDetailsModel.value?.blockName}', style: Styles.blue17),
                                          Text('${controller.validTillTimeCtrlr.text}', style: Styles.blue17),
                                          // Text(
                                          //     '${controller.viewPermitDetailsModel.value?.permitTypeName}',
                                          //     style: Styles.blue17),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          SizedBox(
                                            child: Text('${controller.viewPermitDetailsModel.value?.permitNo}', style: Styles.blue17),
                                          ),
                                          // Text(
                                          ...
                                          //   height: 5,
                                          // ),
                                          Text('${controller.viewPermitDetailsModel.value?.permitTypeName}', style: Styles.blue17),
                                        ],
                                      ),
                                    ],
                                  ),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Dimens.boxHeight5,
                                      Container(
                                        child: Text('${controller.viewPermitDetailsModel.value?.description}', style: Styles.blue17),
                                      ),
                                    ],
                                  ),
                                ),
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: []..addAll(controller.listIsolation!.map((element) => Row(
                                              mainAxisSize: MainAxisSize.min,
                                              mainAxisAlignment: MainAxisAlignment.end,
                                              crossAxisAlignment: CrossAxisAlignment.end,
                                              children: [Text("${element?.isolationAssetsCatName?.split(',')}", style: Styles.blue17)],
                                            ))),
                                      ),
                                    ],
                                  ),
                                ...
                                Container(
                                  margin: Dimens.edgeInsets20,
                                  height: ((controller.listLoto?.length ?? 0) * 40) + 130,
                                  decoration: BoxDecoration(
                                    border: Border.all(
                                      color: ColorValues.lightGreyColorWithOpacity35,
                                      width: 1,
                                      ...
                                      Expanded(
                                        child: DataTable2(
                                          ...
                                          rows: List<DataRow>.generate(
                                            ...
                                            (index) => DataRow(cells: [
                                              DataCell(Text(controller.listLoto?[index]?.asset_name.toString() ?? '')),
                                              DataCell(Text(controller.listLoto?[index]?.locksrno.toString() ?? '')),
                                            ]),
                                          ),
                                        ),
                                      ),
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                      width: 150,
                                                      child: Text('${controller.viewPermitDetailsModel.value?.job_type_name ?? 'No Data Found'}',
                                                          style: Styles.blue17),
                                                    ),
                                                    ...
                                                    SizedBox(
                                                      width: 200,
                                                      child: Text('${controller.viewPermitDetailsModel.value?.sop_type_name ?? 'No Data Found'}',
                                                          style: Styles.blue17),
                                                    ),
                                                    // Checkbox(
                                                    //   value: controller
                                ...
                                controller.viewPermitDetailsModel.value?.ptwStatus == PermitStatusConstants.PTW_EXTEND_REQUESTED //133
                                        ||
                                        controller.viewPermitDetailsModel.value?.ptwStatus == PermitStatusConstants.PTW_EXTEND_REQUEST_APPROVE //135
                                    ? SizedBox(
                                        width: MediaQuery.of(context).size.width / 1,
                                        child: Padding(
                                ...
                                controller.viewPermitDetailsModel.value?.ptwStatus == PermitStatusConstants.PTW_CANCELLED_BY_APPROVER //129
                                        ||
                                ...
                                controller.viewPermitDetailsModel.value?.ptwStatus == PermitStatusConstants.PTW_CLOSED //126
                                    ? SizedBox(
                                        width: MediaQuery.of(context).size.width / 1,
                                        child: Padding(
                                          padding: const EdgeInsets.all(20),
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          controller.viewPermitDetailsModel.value?.ptwStatus == PermitStatusConstants.PTW_APPROVE //125
                                                  ||
                                                  controller.viewPermitDetailsModel.value?.ptwStatus == PermitStatusConstants.PTW_CLOSED //126
                                                  ||
                                                  controller.viewPermitDetailsModel.value?.ptwStatus ==
            ...
            children: [
              ...
              varUserAccessModel.value.access_list!
                  ...
                  ? Container(
                      ...
                      child: CustomElevatedButton(
                        ...
                        text: controller.viewPermitDetailsModel.value?.ptwStatus == PermitStatusConstants.PTW_EXTEND_REQUESTED //133
                            ? "Extend Approve"
                            : "Approve Permit",
                        icon: Icons.add,
                        onPressed: () {
              ...
              controller.viewPermitDetailsModel.value?.isExpired == 1 ||
                      controller.viewPermitDetailsModel.value?.requester_id == varUserAccessModel.value.user_id &&
                          ...
                          &&
                          varUserAccessModel.value.access_list!
                                  .where((e) => e.feature_id == UserAccessConstants.kPermitFeatureId && e.edit == UserAccessConstants.kHaveEditAccess)
                                  .length >
                              0
                  //          ||
              ...
              varUserAccessModel.value.access_list!
                              .where((e) => e.feature_id == UserAccessConstants.kPermitFeatureId && e.add == UserAccessConstants.kHaveAddAccess)
                              .length >
                          0 &&
              ...
              varUserAccessModel.value.access_list!
                              .where(
                                  (e) => e.feature_id == UserAccessConstants.kPermitFeatureId && e.approve == UserAccessConstants.kHaveApproveAccess)
                              .length >
                          0 &&
                      controller.viewPermitDetailsModel.value?.ptwStatus == PermitStatusConstants.PTW_CANCEL_REQUESTED //130
                  ? Container(
    ...
    return Column(//
      ...
      Align(
        ...
        child: Padding(
          ...
          child: RichText(
            text: TextSpan(text: 'Start Date: ', style: Styles.blackBold16, children: []),
          ),
        ),
      ),
      Dimens.boxHeight5,
    ...
    return Column(//
      ...
      Align(
        ...
        child: Padding(
          padding: const EdgeInsets.only(left: 10),
          child: RichText(
            text: TextSpan(text: 'Valid Till: ', style: Styles.blackBold16, children: []),
          ),
        ),
      ),
      Dimens.boxHeight5,
    ...
    return Column(//
      ...
      Align(
        ...
        child: Padding(
          padding: const EdgeInsets.only(left: 10),
          child: RichText(
            text: TextSpan(text: 'Permit Description: ', style: Styles.blackBold16, children: [
              TextSpan(
                text: '*',
                style: TextStyle(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              errorBorder: controller.isJobDescriptionInvalid.value
                  ...
                  : null,
              errorText: controller.isJobDescriptionInvalid.value ? "Required field" : null,
            ),
            onChanged: (value) {
              if (value.trim().length > 3) {
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                errorBorder: controller.isTitleTextInvalid.value
                    ...
                    : null,
                errorText: controller.isTitleTextInvalid.value ? "Required field" : null,
              ),
              onChanged: (value) {
                if (value.trim().length > 3) {
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                ...
                SizedBox(
                  ...
                  child: CustomMultiSelectDialogField(
                    ...
                    initialValue: (controller.selectedEquipmentNameList.isNotEmpty) ? controller.selectedEquipmentNameIdList : [],
                    ...
                    onConfirm: (selectedOptionsList) => {
                      ...
                      print('Equipment Name list25: ${controller.selectedEquipmentNameIdList}')
                    },
                  ),
                )
              ]),
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                ...
                SizedBox(
                  ...
                  child: CustomMultiSelectDialogField(
                    ...
                    initialValue: (controller.selectedEmployeeNameList.isNotEmpty) ? controller.selectedEmployeeNameIdList : [],
                    ...
                    onConfirm: (selectedOptionsList) => {
                      ...
                      print('Employee Name list50: ${controller.selectedEmployeeNameIdList}')
                    },
                  ),
                )
              ]),
