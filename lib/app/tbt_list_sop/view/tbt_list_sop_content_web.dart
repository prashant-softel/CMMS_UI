          ...
          children: [
            ...
            Expanded(
              child: Row(
                ...
                children: [
                  varUserAccessModel.value.access_list!.where((e) => e.feature_id == 13 && e.add == 0).length > 0
                      ? Container(
                          width: (Get.width * .403),
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Align(
                                                  ...
                                                  child: Text(
                                                    controller.fileName.value == "" ? 'File Name' : controller.fileName.value,
                                                    maxLines: 3,
                                            ...
                                            Container(
                                              ...
                                              child: CustomElevatedButton(
                                                ...
                                                size: 12,
                                                onPressed: () {
                                                  controller.browseFiles(fileBytes: controller.fileBytes, position: 0).then((value) {
                                                    controller.isSuccessDialog();

                                                    Fluttertoast.showToast(msg: "file upload  Successfully", fontSize: 16.0);
                                                  });
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Align(
                                                  alignment: Alignment.topLeft,
                                                  child: Text(
                                                    controller.fileName2.value == "" ? 'File Name' : controller.fileName2.value,
                                                    maxLines: 3,
                                                    textAlign: TextAlign.center,
                                                    style: Styles.greyLight14,
                                                  ),
                                            ...
                                            Container(
                                              ...
                                              child: CustomElevatedButton(
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if (result != null) {
                                                    // for (var file in result.files) {
                                                    controller.fileName2.value = result.files.single.name;
                                                    controller.fileBytes2 = result.files.single.bytes;
                                                    //controller.filePath.value = file.;
                                            ...
                                            Container(
                                              ...
                                              child: CustomElevatedButton(
                                                ...
                                                size: 12,
                                                onPressed: () {
                                                  controller.browseFiles(fileBytes: controller.fileBytes2, position: 1).then((value) {
                                    ...
                                    Container(
                                        ...
                                        child: controller.selectedItem == null
                                            ? CustomElevatedButton(
                                                backgroundColor: ColorValues.appDarkBlueColor,
                                                onPressed: () {
                                                  controller.createSOP().then((value) {
                                                    print("value,$value");
                                                    if (value == true) controller.issuccessCreatechecklist();
                                                  });
                                                },
                                            ...
                                            : CustomElevatedButton(
                                                backgroundColor: ColorValues.appDarkBlueColor,
                                                onPressed: () {
                                                  controller.updateSop(controller.selectedItem?.id).then((value) {
                                                    print("value,$value");
                                                    if (value == true) controller.issuccessCreatechecklist();
                                                  });
                                                },
                      ...
                      : Container(),
                  varUserAccessModel.value.access_list!.where((e) => e.feature_id == 13 && e.view == 0).length > 0
                      ? Expanded(
                          child: Container(
                            width: Get.width * 7,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  controller.sopPermitList.isEmpty
                                      ...
                                      : Expanded(
                                          child: ScrollableTableView(
                                            paginationController: controller.jobSOPListPaginationController,
                                            columns: ["Sr.No.", "Title", "Job Type Name", "Action"].map((column) {
                                              return TableViewColumn(
                                            ...
                                            rows: //
                                              ...
                                              ...List.generate(
                                                controller.sopPermitList.length,
                                                (index) {
                                                  var jobSOPListDetails = controller.sopPermitList[index];
                                                  return [
                                                            ...
                                                            : (value == "Action")
                                                                ? Wrap(alignment: WrapAlignment.center, children: [
                                                                    ...
                                                                    TableActionButton(
                                                                      ...
                                                                      message: 'Edit',
                                                                      onPress: () {
                                                                        controller.selectedItem = controller.sopPermitList
                                                                            .firstWhere((element) => "${element.id}" == _permitTypeList[0]);

                                                                        controller.titleTextFieldCtrlr.text = controller.selectedItem?.name ?? '';
                                                                        controller.descriptionTextFieldCtrlr.text =
                                                                    ...
                                                                    TableActionButton(
                                                                      ...
                                                                      onPress: () {
                                                                        controller.isDeleteDialog(
                                                                            business_id: _permitTypeList[0], business: _permitTypeList[1]);
                                                                      },
                                                                    )
                                                                    // : Container()
                                                                  ])
                                  ...
                                  Padding(
                                    ...
                                    child: ValueListenableBuilder(
                                        valueListenable: controller.jobSOPListPaginationController,
                                        builder: (context, value, child) {
                                          return Row(children: [
                                            ...
                                            Row(children: [
                                              IconButton(
                                                onPressed: controller.jobSOPListPaginationController.currentPage <= 1
                                                    ? null
                                                    : () {
                                                        controller.jobSOPListPaginationController.previous();
                                                      },
                                                iconSize: 20,
                                                splashRadius: 20,
                                                icon: Icon(
                                                  Icons.arrow_back_ios_new_rounded,
                                                  color: controller.jobSOPListPaginationController.currentPage <= 1
                                                      ? Colors.black26
                                                      : Theme.of(context).primaryColor,
                                                ),
                                              ),
                                              IconButton(
                                                onPressed: controller.jobSOPListPaginationController.currentPage >=
                                                        controller.jobSOPListPaginationController.pageCount
                                                    ? null
                                                    : () {
                                                        controller.jobSOPListPaginationController.next();
                                                      },
                                                iconSize: 20,
                                                splashRadius: 20,
                                                icon: Icon(
                                                  Icons.arrow_forward_ios_rounded,
                                                  color: controller.jobSOPListPaginationController.currentPage >=
                                                          controller.jobSOPListPaginationController.pageCount
                                                      ? Colors.black26
                                                      : Theme.of(context).primaryColor,
                                                ),
