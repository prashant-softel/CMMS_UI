...
class PemitstoworkTBTWeb extends StatefulWidget {
  PemitstoworkTBTWeb({
    Key? key,
  }) : super(key: key);

  @override
  State<PemitstoworkTBTWeb> createState() => _ViewPemitstoworkTBTWebState();
}

class _ViewPemitstoworkTBTWebState extends State<PemitstoworkTBTWeb> {
  final HomeController homecontroller = Get.find();

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CreatePemitstoworkTBTController>(
      id: 'stock_Mangement',
      builder: (controller) {
