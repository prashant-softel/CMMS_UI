...
class FrequencyListContentMobile
    extends GetView<FrequencyListController> {
  FrequencyListContentMobile({Key? key}) : super(key: key);
            ...
            children: [
              Expanded(
                child: ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: controller.frequencyList != null
                        ? controller.frequencyList?.length
                        : 0,
                    itemBuilder: (context, index) {
                      final preventiveCheckListModel =
                          (controller.frequencyList != null)
                              ? controller.frequencyList![index]
                              : FrequencyModel();
                      return Container(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Row(//
                                    ...
                                    Expanded(
                                      child: Text(
                                        '${preventiveCheckListModel?.days ?? 0}',
