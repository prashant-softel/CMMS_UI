...
class StatutoryComplianceContentWeb extends GetView<StatutoryComplianceController> {
  StatutoryComplianceContentWeb({Key? key}) : super(key: key);
  final StatutoryComplianceController controller = Get.find();
                        ...
                        child: Obx(() {
                          return Text(
                            controller.isContainerVisible.value
                                ? 'Close Create Statutory'
                                : 'Open Create Statutory ',
                          );
                        }),
                      ),
                    )
                                                ...
                                                Text(
                                                  controller.isFormInvalid ==
                                                      ...
                                                      ? controller.selectedItem ==
                                                              null
                                                          ? "Statutory Create Successfully in the List."
                                                          : "Statutory updated Successfully in the List."
                                    ...
                                    child: controller.selectedItem == null
                                        ? Container(
                                            ...
                                            child: CustomElevatedButton(
                                              ...
                                              onPressed: () {
                                                controller.createStatutoryCompliance().then(
                                                  (value) {
                                                    print("CREATE");
                                                    print("value,$value");
                                                    if (value == true) {
                                        ...
                                        : CustomElevatedButton(
                                            ...
                                            onPressed: () {
                                              controller
                                                  .updateStatutoryCompliance(controller
                                                      .selectedItem?.id)
                                                  .then(
                                                (value) {
                                                  print("UPDATE");
                        ...
                        child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              controller.StatutoryCompliance.isEmpty == true &&
                                          ...
                                          child: Obx(
                                            () => DataTable2(
                                              ...
                                              rows: List<DataRow>.generate(
                                                controller.StatutoryCompliance.length ?? 0,
                                                (index) => DataRow(cells: [
                                                  DataCell(Text(
                                                      (index + 1).toString())),
                                                  DataCell(Text(controller
                                                          .StatutoryCompliance[index].name
                                                          .toString() ??
                                                      '')),
                                                  // DataCell(Text(controller
                                                  //         .StatutoryCompliance[index]
                                                  //         .description ??
                                                      // '')),
                                                  DataCell(Row(
                                                    children: [
                                                          ...
                                                          ? TableActionButton(
                                                              ...
                                                              onPress: () {
                                                                controller.isDeleteDialog(
                                                                    StatutoryCompliance_id: controller
                                                                        .StatutoryCompliance[
                                                                            index]
                                                                        .id
                                                                        .toString(),
