            ...
            child: (value == 'id')
                ...
                : (value == 'Actions')
                    ? Wrap(children: [
                        ...
                        //         id: record[0], generatedBy: record[1]);
                        //   },
                        // ),
                      ])
                    : Text(value.toString()),
...
// import '../../widgets/custom_elevated_button.dart';
// import '../../widgets/table_action_button.dart';
// import '../request_goods_orders_list_controller.dart';
...
//                                               (index) {
//                                                 return [
//                                                   '${controller.goodsOrdersList![index]?.request_order_id}',

//                                                   '${controller.goodsOrdersList![index]?.generatedBy}',
//                                                   '${controller.goodsOrdersList![index]?.generatedAt}',
...
//                               // Get.toNamed(
//                               //   Routes.PurchaseGoodsorderListScreen,
//                               // );
//                             },
//                           ),
//                         ),
