                                                                    ...
                                                                    : TableActionButton(
                                                                        ...
                                                                        onPress:
                                                                          ...
                                                                          controller.selectedItem = controller.scheduleCheckPoint!.firstWhere((element) =>
                                                                              "${element?.schedule_id}" ==
                                                                              controller.scheduleCheckPoint?[index]?.schedule_id.toString());
                                                                    ...
                                                                    varUserAccessModel.value.access_list!.where((e) => e.feature_id == UserAccessConstants.kPermitFeatureId && e.view == UserAccessConstants.kHaveViewAccess).length >
                                                                        ...
                                                                        ? TableActionButton(
                                                                            ...
                                                                            onPress:
                                                                              ...
                                                                              controller.viewNewPermitList(permitId: controller.pmtaskViewModel.value?.permit_id, jobId: controller.jobDetailsModel.value!.id ?? 0);
                                                                            })
                                                                        : Container(),
                                                                    // TableActionButton(
                                                                    //     color: ColorValues
