...
class SchedulePermitListTableDialog
    extends GetView<PreventiveMaintenanceTaskViewController> {
  const SchedulePermitListTableDialog({super.key});
                          ...
                          Column(
                            ...
                            Expanded(
                              child: DataTable2(
                                ...
                                dataRowHeight: 90, //Get.height * 0.08,
                                columnSpacing:
                      ...
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            (controller.isPermitLinked.value == true)
                                ? CustomElevatedButton(
                                    text: 'View Job', onPressed: () {} //=>
                                    //controller.goToJobDetailsScreen(),
                                    )
                                : CustomElevatedButton(
                                    text: 'Link',
                                    onPressed:
                                        () {} //=> controller.linkToPermit(),
                                    ),
                            Text(controller.responseMessage.value),
                          ],
                        ),
