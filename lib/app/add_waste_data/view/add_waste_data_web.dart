...
class AddWasteDataWeb extends StatefulWidget {
  ...
  @override
  State<AddWasteDataWeb> createState() => _WaterDataWebState();
}

class _WaterDataWebState extends State<AddWasteDataWeb> {
  @override
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                            "Solid waste( Paper waste, Food waste, Plastic waste, metal, Glass etc) Usage:",
                                            style: Styles.blue14),
                                      ],
                                    ),
                                    Dimens.boxHeight5,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          GestureDetector(
              child: Text(" /VIEW WASTE DATA", style: Styles.greyLight14)),
        ],
      ),
    );
  }
