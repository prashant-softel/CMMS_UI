...
class AddWasteDataController extends GetxController {
  AddWasteDataController(
    this.addWasteDataPresenter,
  );
  AddWasteDataPresenter addWasteDataPresenter;
  ...
  Future<void> setType() async {
    try {
      // Read jobId
      String? _type = await addWasteDataPresenter.getValue();
