...
class BloodListContentWeb extends GetView<BloodListController> {
  BloodListContentWeb({Key? key}) : super(key: key);
  final BloodListController controller = Get.find();
