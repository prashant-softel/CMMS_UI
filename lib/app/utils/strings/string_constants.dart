...
once extended, remains valid up to a maximum time of 4hrs.""";
  ...
  static String extendCheck2PermitText = """WORKFORCE & WORKING CONDITION of the site will remain unaltered 
  ...
  static String cancelWorkPermitCheck2 = """Unsafe Workplace Condition (Inadequate Barriers/Guards/ Extreme Weather\nConditions/ Improper Access-Egress/Inadequate Lighting/Ventilation /Inadequate\nWarning Signages).""";
