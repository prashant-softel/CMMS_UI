...
//   EditPermitController(this.editPermitPresenter, this.jobListPresenter);
...
//   EditPermitPresenter editPermitPresenter;
...
//     final list = await editPermitPresenter.getInventoryDetailList(
//       isLoading: true,
//       id: 14430
//     );
...
//     final _assignedToList = await editPermitPresenter.getAssignedToList();
...
//     final _employeeNameList = await editPermitPresenter.getEmployeePermitList(
//       isLoading: true,
...
//     final _permitIssuerList = await editPermitPresenter.getPermitIssuerList(
//       isLoading: true,
//       // categoryIds: categoryIds,
//       facility_id: 45,
//     );
...
//     final _permitApproverList = await editPermitPresenter.getPermitApproverList(
//       isLoading: true,
//       // categoryIds: categoryIds,
//       facility_id: 45,
//     );
...
//     final _jobTypeList = await editPermitPresenter.getJobTypePermitList(
//       isLoading: true,
...
//     final _sopPermitList = await editPermitPresenter.getSopPermitList(
//       isLoading: true,
//       // categoryIds: categoryIds,
...
//     blockList.value = <BlockModel>[];
//     final _blockList =
//         await editPermitPresenter.getBlocksList(facilityId: _facilityId);
...
//         await editPermitPresenter.getInventoryCategoryList(
//       isLoading: true,
//     );
...
//         await editPermitPresenter.getInventoryIsolationList(
//       isLoading: true,
//     );
...
//         await editPermitPresenter.getInventoryEquipmentNameList(
//       isLoading: true,
//       categoryIds:categoryIds,
...
//     final _facilityList = await editPermitPresenter.getFacilityLists();
...
//     final _permitTypeList = await editPermitPresenter.getTypePermitList();
...
//           await editPermitPresenter.createNewPermit(
