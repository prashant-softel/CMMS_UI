            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(
                    left: 50, bottom: 5), // Reduced top and bottom padding
                child: Row(
                  children: [
                    Text('Select Plant', style: Styles.black13W400),
                    // Dimens.boxWidth10,
                    SizedBox(width: 10),
                    Obx(
                      () => SizedBox(
                        ...
                        child: Container(
                          ...
                          child: DashCustomMultiSelectDialogField(
                            ...
                            initialValue: controller.homecontroller.facilityList
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Row(
                      children: [
                        Text('Date Range', style: Styles.black13W400),
                        // Dimens.boxWidth10,
                        SizedBox(width: 10),
