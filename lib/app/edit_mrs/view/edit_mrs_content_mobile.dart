...
class EditMrsContentMobile extends GetView<EditMrsController> {
  EditMrsContentMobile({Key? key}) : super(key: key);
                                                                  ...
                                                                  : (mapData['key'] ==
                                                                      ...
                                                                      : (mapData['key'] ==
                                                                          ...
                                                                          : (mapData['key'] == "Material_Type")
                                                                              ? Text("${controller.dropdownMapperData.value[controller.rowItem.value[0]]?.asset_type ?? ""}")
                                                                              : Text(mapData['key'] ?? ''),
                                                        ],
                                                      );
                                                    }).toList(),
