...
class UnitOfMeasurementWeb
    extends GetView<UnitOfMeasurementController> {
  UnitOfMeasurementWeb({Key? key}) : super(key: key);
  final UnitOfMeasurementController controller = Get.find();
                                  ...
                                  Row(
                                    ...
                                    children: [ 
                                      Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                        children: [
                                          CustomRichText(title:"Spare Multi Selection"),
                                          SizedBox(width:12),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                  ...
                                  ...List.generate(
                                    controller.moduleList
                                      ...
                                      return [
                                        ...
                                        '${moduleListDetails?.decimal_status}',
                                        '${moduleListDetails?.spare_multi_selection}',
