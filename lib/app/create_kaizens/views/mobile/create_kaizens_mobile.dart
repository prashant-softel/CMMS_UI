...
@override
  State<CreateKaizensMobile> createState() =>
      _CreateKaizensMobileState();
}
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomTextfieldMobile(
                              ...
                              textController: controller.KaizensImplementedCtrl,
                              // errorController: controller.isKaizensImplementedInvalid.value
                              //     ? "Required field"
                              //     : null,
                              onChanged: (value) {
                                if (value.trim().length > 0) {
                                  controller.isKaizensImplementedInvalid.value = false;
                                } else {
                                  controller.isKaizensImplementedInvalid.value = true;
                                }
                              },
                            ),
                            Dimens.boxHeight15,
                            ...
                            CustomRichTextMobile(
                              title: "Cost inquired for implementation of Kaizens: ",
                            ),
                            Dimens.boxHeight2,
                            CustomTextfieldMobile(
                              width: MediaQuery.of(context).size.width / 1.1,
                              ...
                              onChanged: (value) {
                                if (value.trim().length > 0) {
                                  controller.isCostForImplementationInvalid.value = false;
                                } else {
                                  controller.isCostForImplementationInvalid.value = true;
                                }
                              },
                            ),
                            Dimens.boxHeight15,
                            CustomRichTextMobile(
                              title: "Cost saved from the Implementation of Kaizens: ",
                            ),
                            Dimens.boxHeight2,
                            CustomTextfieldMobile(
                              width: MediaQuery.of(context).size.width / 1.1,
                              keyboardType: TextInputType.number,
                              textController: controller.CostSavedFromImplementationCtrl,
                              // errorController: controller.isCorrectiveInvalid.value
                              //     ? "Required field"
                              //     : null,
                              onChanged: (value) {
                                if (value.trim().length > 0) {
                                  controller.isCostSavedFromImplementationInvalid.value = false;
                                } else {
                                  controller.isCostSavedFromImplementationInvalid.value = true;
                                }
                              },
                            ),
                            Dimens.boxHeight15,
