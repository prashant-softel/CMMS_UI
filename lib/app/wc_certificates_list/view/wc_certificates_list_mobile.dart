...
class WcCertificatesListMobile extends StatefulWidget {
  const WcCertificatesListMobile({Key? key}) : super(key: key);

  @override
  _WcCertificatesListMobileState createState() =>
      _WcCertificatesListMobileState();
}

class _WcCertificatesListMobileState extends State<WcCertificatesListMobile> {
  @override
