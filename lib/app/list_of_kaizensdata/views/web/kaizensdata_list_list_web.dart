...
class KaizensdataListWeb extends StatefulWidget {
  ...
  @override
  State<KaizensdataListWeb> createState() => _KaizensdataListWebState();
}

class _KaizensdataListWebState extends State<KaizensdataListWeb> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<KaizensDataListController>(
        ...
        builder: (controller) {
          return Obx(
            () {
              final dataSource = KaizensDataListSource(controller);
...
class KaizensDataListSource extends DataTableSource {
  final KaizensDataListController controller;

  late List<GetKaizensDataList?> filteredGetFuelDataList;

  KaizensDataListSource(this.controller) {
  ...
  DataRow? getRow(int index) {
    // print({"getRow call"});
    final KaizensDataDetails = filteredGetFuelDataList[index];
