...
import '../kaizensdata_list_controller.dart';

class KaizensListScreen extends GetView<KaizensDataListController> {
  KaizensListScreen({super.key});
  final controller = Get.find<KaizensDataListController>();
