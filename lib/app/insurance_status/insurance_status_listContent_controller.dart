...
class InsuranceStatusController extends GetxController {
  ...
  InsuranceStatusPresenter moduleListPresenter;
  ...
  RxList<InsuranceStatusModel?>?
  moduleList =
      <InsuranceStatusModel?>[].obs;
  int facilityId = 0;
  int type = 1;
  ...
  InsuranceStatusModel? moduleListModel;
  ...
  InsuranceStatusModel? selectedItem;
  ...
  void onInit() async {
    ...
    facilityIdStreamSubscription = homecontroller.facilityId$.listen((event) {
      ...
      Future.delayed(Duration(seconds: 2), () {
        getInsuranceStatus(facilityId, type, true);
      });
    });
    super.onInit();
  }

  Future<void> getInsuranceStatus(
      int facilityId, int type, bool isLoading)
  async {
    moduleList?.value = <InsuranceStatusModel>[];
    final _moduleList =
        await moduleListPresenter.getInsuranceStatus( isLoading: isLoading);
