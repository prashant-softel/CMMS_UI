...
class DocVersionDashboardScreen extends GetView<DocVersionDashbordController> {
  DocVersionDashboardScreen({super.key});

  final DocVersionDashbordController controller = Get.find();
