...
class _CreateOccupationalhealthMobileState
    extends State<CreateOccupationalhealthMobile> {
  @override
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomTextfieldMobile(
                                ...
                                textController:
                                    controller.noofhealthexamsofnewjoinerCtrl,
                              ...
                              CustomTextfieldMobile(
                                width: MediaQuery.of(context).size.width / 1.1,
                                keyboardType: TextInputType.number,
                                textController: controller.periodictestsCtrl,
                                // errorController: controller.isPeriodictestInvalid.value
                                //     ? "Required field"
                                //     : null,
                                onChanged: (value) {
                                  if (value.trim().length > 0) {
                                    controller.isPeriodictestInvalid.value =
                                        false;
                                  } else {
                                    controller.isPeriodictestInvalid.value =
                                        true;
                              ...
                              CustomTextfieldMobile(
                                ...
                                keyboardType: TextInputType.number,
                                textController:
                                    controller.occupationalillnessesCtrl,
                                // errorController: controller.isOccupationalIllnessesInvalid.value
                                //     ? "Required field"
                                //     : null,
                                onChanged: (value) {
                                  if (value.trim().length > 0) {
                                    controller.isOccupationalIllnessesInvalid
                                        .value = false;
                                  } else {
                                    controller.isOccupationalIllnessesInvalid
                                        .value = true;
