...
class BodyInjuredWeb extends GetView<BodyInjuredController> {
  BodyInjuredWeb({Key? key}) : super(key: key);
  final BodyInjuredController controller = Get.find();
                ...
                child: Obx(() {
                  return Text(
                    controller.isContainerVisible.value
                        ? 'Close Create Body Injured'
                        : 'Open Create Body Injured',
                  );
                }),
              ),
            ),
                                              ...
                                              Text(
                                                controller.isFormInvalid ==
                                                    ...
                                                    ? controller.selectedItem ==
                                                            null
                                                        ? "BodyPart Create Successfully in the List."
                                                        : "BodyPart updated Successfully in the List."
