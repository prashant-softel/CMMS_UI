...
class DeployedTeam extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => IgnorePointer(
        ignoring: controller.jobCardDetailsModel.value!.status == 156 ||
            controller.jobCardDetailsModel.value!.status == 158,
        child: Container(
          margin: Dimens.edgeInsets20,
          height: 300,
              ...
              Expanded(
                child: Obx(() {
                  ...
                  return DataTable2(
                    ...
                    rows: controller.employeesDeployed.value.map((record) {
                      List<DataCell> cells = [];
                      ...
                      cells.add(
                        DataCell(
                          DropdownWebWidget(
                            ...
                            selectedValue: record[0]["value"],
                            onValueChanged: (list, selectedValue) {
                              record[0]["value"] = selectedValue;
                      ...
                      cells.add(
                        DataCell(
                          Text(
                            controller
                                    .deployedEmployeeMapperData[record[0]
                                        ['value']]
                                    ?.designation ??
                                "No Designation",
                          ),
                        ...
                        cells.add(
                          DataCell(
                            TableActionButton(
                              ...
                              message: '',
                              onPress: () {
                                controller.employeesDeployed.remove(record);
                              },
                            ),
                          ),
                        );
