...
class AddUserMessageApproveDialog extends GetView {
  String? data;
  int? id;
  int? position;

  AddUserMessageApproveDialog({super.key, this.data, this.id, this.position});
    ...
    return SelectionArea(
      child: StatefulBuilder(builder: ((context, setState) {
        return AlertDialog(
          ...
          title: Text(
            position == 1 ? 'Create User' : 'Update User',
