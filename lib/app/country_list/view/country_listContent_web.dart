...
//
// class CountryListContentWeb
//     extends GetView<CountryListController> {
...
//                                                     label: 'Edit',
//                                                     onPress: () {
//                                                       controller.selectedItem = controller.countryList!.firstWhere((element) => "${element?.id}" == _countryList[0]);
//
...
//                                                     label: 'Delete',
//                                                     onPress: () {
//                                                       print(_countryList[0]);
//                                                       controller.isDeleteDialog(module_id: _countryList[0], module: _countryList[1]);
//                                                     },
//                                                   )
//                                                   // : Container()
//                                                 ])
                                              ...
                                              onChanged:
                                                ...
                                                children: [
                                                  ...
                                                  TableActionButton(
                                                    ...
                                                    label: 'Edit',
                                                    onPress: () {
                                                      controller.selectedItem = controller.countryList!.firstWhere((element) => "${element?.id}" == _moduleList[0]);
                                                  ...
                                                  TableActionButton(
                                                    color: ColorValues.facebookButtonColor,
