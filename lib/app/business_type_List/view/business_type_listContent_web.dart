                                        ...
                                        child: controller.selectedItem == null
                                            ...
                                            : CustomElevatedButton(
                                                ...
                                                backgroundColor: ColorValues
                                                    .appDarkBlueColor,
                                                onPressed: () {
                                                  print("Test for updation,$controller.selectedItem");
                                                  controller
                                                      .updateBusinessTypeNumber(
                                                          controller
                                                              .selectedItem?.id , controller.selectedItem?.status)
                                                      .then((value) {
                                                    print("value,$value");
                                                    if (value == true)
                                                      controller
                                                    ...
                                                    return TableViewCell(
                                                        child: (value == 'No')
                                                            ...
                                                            : (value ==
                                                                ...
                                                                ? Row(
                                                                    children: [
                                                                        // varUserAccessModel.value.access_ list!.where((e) => e.feature_id == 5 && e.edit == 0).length >
                                                                        //         0
                                                                        //     ?
                                                                        TableActionButton(
                                                                                ...
                                                                                onPress: () {
                                                                                  ...
                                                                                  // print(controller.preventiveCheckList?.id);
                                                                                  controller.selectedItem = controller.preventiveCheckList!.firstWhere((element) => "${element?.id}" ==
...
//                                                     onPress: () {
//                                                       print(_moduleList[0]);
//                                                       controller.selectedItem = controller.preventiveCheckList!.firstWhere((element) => "${element?.id}" == _moduleList[0]);
//                                                       print(controller.selectedItem?.id);
//                                                       controller.nameCtrlr.text = controller.selectedItem?.name ?? '';
//                                                       controller.descriptionCtrlr.text = controller.selectedItem?.description ?? '';
//                                                     },
...
//                                                     onPress: () {
//                                                       print(_moduleList[0]);
//                                                       controller.isDeleteDialog(checklist_id: _moduleList[0], checklist: _moduleList[1]);
//                                                     },
//                                                   )
//                                                   // : Container()
//                                                 ])
