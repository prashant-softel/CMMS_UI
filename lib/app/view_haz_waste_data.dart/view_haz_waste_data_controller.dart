...
class ViewHazWasteDataController extends GetxController {
  ViewHazWasteDataController(
    this.viewHazaddWasteDataPresenter,
  );
  ViewHazWasteDataPresenter viewHazaddWasteDataPresenter;
  ...
  Future<void> setType() async {
    try {
      // Read jobId
      String? _type = await viewHazaddWasteDataPresenter.getValue();
      if (_type == null || _type == '' || _type == "null") {
        var dataFromPreviousScreen = Get.arguments;

        type.value = dataFromPreviousScreen['type'];
        // addWasteDataPresenter.saveValue(type: type.value.toString());
      } else {
