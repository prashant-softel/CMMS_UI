...
class JobTypeListContentWeb extends GetView<JobTypeListController> {
  JobTypeListContentWeb({Key? key}) : super(key: key);
  final JobTypeListController controller = Get.find();
