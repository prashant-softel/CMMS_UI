...
class TargetedGroupContentWeb extends GetView<TargetedGroupController> {
  TargetedGroupContentWeb({Key? key}) : super(key: key);
  final TargetedGroupController controller = Get.find();
                        ...
                        child: Obx(() {
                          return Text(
                            controller.isContainerVisible.value
                                ? 'Close Create Targeted Group'
                                : 'Open Create  Targeted Group',
                          );
                        }),
                      ),
                    )
                                                ...
                                                Text(
                                                  controller.isFormInvalid ==
                                                      ...
                                                      ? controller.selectedItem ==
                                                              null
                                                          ? "Targeted Group Successfully in the List."
                                                          : "Targeted Group updated Successfully in the List."
                                    ...
                                    child: controller.selectedItem == null
                                        ? Container(
                                            ...
                                            child: CustomElevatedButton(
                                              ...
                                              onPressed: () {
                                                controller.createTargetedGroup().then(
                                                  (value) {
                                                    print("CREATE");
                                                    print("value,$value");
                                                    if (value == true) {
                                        ...
                                        : CustomElevatedButton(
                                            ...
                                            onPressed: () {
                                              controller
                                                  .updateTargetedGroup(controller
                                                      .selectedItem?.id)
                                                  .then(
                                                (value) {
                                                  print("UPDATE");
                        ...
                        child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              controller.TargetedGroup.isEmpty == true &&
                                          ...
                                          child: Obx(
                                            () => DataTable2(
                                              ...
                                              rows: List<DataRow>.generate(
                                                controller.TargetedGroup.length ?? 0,
                                                (index) => DataRow(cells: [
                                                  DataCell(Text(
                                                      (index + 1).toString())),
                                                  DataCell(Text(controller
                                                          .TargetedGroup[index].name
                                                          .toString() ??
                                                      '')),
                                                  DataCell(Text(controller
                                                          .TargetedGroup[index]
