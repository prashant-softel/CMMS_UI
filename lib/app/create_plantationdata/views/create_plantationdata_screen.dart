...
import '../create_plantationdata_controller.dart';

class PlantationDataScreen extends GetView<CreatePlantationDataController> {
  PlantationDataScreen({super.key});
  final controller = Get.find<CreatePlantationDataController>();
