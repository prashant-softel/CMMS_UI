...
//
//     final SavePmModel = SavePmModelFromJson(jsonString);

// import 'dart:convert';

// SavePmModel savePmModelFromJson(String str) =>
//     SavePmModel.fromJson(json.decode(str));

// String savePmModelToJson(SavePmModel data) => json.encode(data.toJson());
...
// ChecklistMapList checklistFromJson(String str) {
//   var checklist = ChecklistMapList.fromJson(json.decode(str));
//   return checklist;
// }

// String checklistToJson(ChecklistMapList data) => json.encode(data.toJson());
